  ...
  const handleReviewSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAuthenticated) {
      toast({
        ...
        action: <ToastAction onClick={handleLoginRedirect} altText="Login">Login</ToastAction>,
      });
      return;
    }
    ...
    try {
      ...
      setRestaurant((prev) => prev && { ...prev, reviews: [...prev.reviews, newReview] });
      setReviewContent('');
      setReviewRating(5);
      ...
      <div>
        ...
        {restaurant.reviews.length === 0 ? (
          ...
          <div
            ...
            style={{ maxHeight: 'calc(3 * 8rem + 2rem)' }} // Adjust based on the approximate height of each review
          >
