...
export default function Home() {
  ...
  //   if (selectedRole === 'Diners') router.push('/restaurants');
  //   else if (selectedRole === 'Business Owners') router.push('/list-restaurants');
  //   else if (selectedRole === 'Admins') router.push('/admin-portal');
  // };
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <UserRoleCard
                ...
                onClick={() => handleRoleLogin('Diners')}
              />
              <UserRoleCard
                ...
                onClick={() => handleRoleLogin('Business Owners')}
              />
              <UserRoleCard
                ...
                onClick={() => handleRoleLogin('Admins')}
              />
            </div>
          </div>
        </section>
